...
'''Functional block scripts====================================================
    New folders can be added as needed to the syslab_fb_scripts folders 
    and must be added below to the scripts_path list. Otherwise, any fb_script 
    names contained in these folders will not be found during a simulation.
    
    IMPORTANT: Do not change the name or location of the "syslab_fb_scripts" 
    folder! To access fb_scripts from another file/folder location,
    use the File path fields in Project Settings
'''

# MV 20.01.r3 28-May-20
# 1 - Removed "syslab_fb_scripts" from root path (now part of main code)
# 2 - Added new folder for custom components/functional blocks
scripts_path_list = []
optical_scripts = 'optical'
electrical_scripts = 'electrical'
digital_scripts = 'digital'
custom_scripts = 'custom'
custom_scripts_aeponyx = 'ng_pon2_aeponyx'
...
scripts_path_list.append(custom_scripts)
scripts_path_list.append(custom_scripts_aeponyx)

'''Functional block library====================================================
    The baseline sections are optical, electrical & digital. Sections, 
    groups and members can be modified (incl. addition or deletion of any of 
    these items)
'''
fb_library_group = []
...
lib_settings_1 = [library_title, library_title_background_color,
                  library_main_w, library_main_h]
...
optical_group  = []
optical_titles = ['Sources/Transmitters', 
                        'Modulators', 
...
opt_sources_transmitters = [ 'WDM Transmitter', 
                                            'CW Laser', 
                                            'CW Laser Array', 
                                            'Gaussian Pulse (Optical)', 
                                            'Noise Source - Optical']

opt_modulators = ['Mach-Zehnder Modulator']

opt_signal_processing = [  'Branching node (Optical)', 
                                        'Optical Adder', 
                                        'Optical Circulator', 
...
opt_passive_devices_couplers = ['Optical Attenuator', 
                                                'X-Coupler (uni-dir)', 
                                                'Optical Splitter', 
                                                'Optical Splitter (4 Port)']

opt_pol_devices = [   'Polarization Beam Splitter', 
...
electrical_group = []
electrical_titles = ['Waveform generators', 
...
elec_waveform_gen = [  'Sine Generator', 
                                    'Cosine Generator', 
                                    'Function Generator', 
...
elec_math_operators = ['Branching Node (Electrical)',
                                    'Adder', 
                                    'Subtractor', 
                                    'Multiplier',
                                    'Sign Inverter', 
...
elec_receivers = [ 'Decision Circuit', 
                            'Integrate and Dump', 
                            'Comparator', 
                            'Analog to Digital Converter']

elec_analyzers = ['Measurement Node (Electrical)', 
...
digital_group = []
digital_titles = ['Binary functional blocks', 
                        'Symbol functional blocks', 
                        'Analyzers']
...
fb_sections_properties = [optical_group_properties, 
                          electrical_group_properties,
...
lib_settings_2 = [library_title, library_title_background_color, 
                  library_main_w, library_main_h]

## Section title, RGBT numbers, Expanding (boolean)
custom_group_properties = ['Device List', 170, 0, 0, 25, True] 
custom_group  = []
custom_titles = ['Devices']

cust_1 = ['Device 1', 'Device 2']
...
# To view and access fb library 2 elements, uncomment the code below
