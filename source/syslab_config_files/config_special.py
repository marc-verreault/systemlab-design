...
'''
num_samples_threshold = 1e8  # Issues warning before starting simulation (simulation can be
                             # aborted)
                             
'''Default font setting for dialogs============================================
Can be specified in pixels (px) or points (pt)
'''
global_font = 'font-size: 8pt; font-family: Segoe UI;'

vary_project_settings = True
time_window = 1e-7

# EYE DIAGRAM
oma_reference = None
decision_threshold = None
decision_point_ui = 0.5
histogram_width = 10 # Percent
histogram_coverage = 99.9 # Percent