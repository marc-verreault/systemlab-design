...
optical_freq_fig_back_color = '#f9f9f9'
optical_freq_plot_back_color = '#f9f9f9'
optical_freq_labels_axes_color = 'black'
optical_freq_signal_color = 'b'
optical_freq_signal_linestyle = '--'
optical_freq_signal_linewidth = 0.8
optical_freq_signal_marker = 'o'
optical_freq_signal_markersize = 3
optical_freq_noise_color = 'r'
optical_freq_noise_linestyle = '--'
optical_freq_noise_linewidth = 0.8
optical_freq_noise_marker = 'o'
optical_freq_noise_markersize = 3
optical_freq_sig_noise_color = 'g'
optical_freq_sig_noise_linestyle = '--'
optical_freq_sig_noise_linewidth = 0.8
optical_freq_sig_noise_marker = 'o'
optical_freq_sig_noise_markersize = 3
optical_freq_psd_noise_color = 'orange'
optical_freq_psd_noise_linestyle = '--'
optical_freq_psd_noise_linewidth = 0.8
optical_freq_psd_noise_marker = 'o'
optical_freq_psd_noise_markersize = 3
# Freq-domain tab (background and grid settings)
optical_freq_maj_grid_linestyle = ':'
optical_freq__maj_grid_linewidth = 0.5
optical_freq_maj_grid_color = 'gray'
optical_freq__min_grid_linestyle = ':'
optical_freq__min_grid_linewidth = 0.5
optical_freq__min_grid_color = 'lightGray'
# Freq-data (all ch) tab (data plots)
opt_chnls_freq_fig_back_color = '#f9f9f9'
opt_chnls_freq_plot_back_color = '#f9f9f9'
opt_chnls_freq_labels_axes_color = 'black'
opt_chnls_freq_signal_color = 'b'
opt_chnls_freq_signal_linestyle = '--'
opt_chnls_freq_signal_linewidth = 0.8
opt_chnls_freq_signal_marker = 'o'
opt_chnls_freq_signal_markersize = 3
opt_chnls_freq_noise_color = 'r'
opt_chnls_freq_noise_linestyle = '--'
opt_chnls_freq_noise_linewidth = 0.8
opt_chnls_freq_noise_marker = 'o'
opt_chnls_freq_noise_markersize = 3
opt_chnls_freq_sig_noise_color = 'g'
opt_chnls_freq_sig_noise_linestyle = '--'
opt_chnls_freq_sig_noise_linewidth = 0.8
opt_chnls_freq_sig_noise_marker = 'o'
opt_chnls_freq_sig_noise_markersize = 3
opt_chnls_freq_psd_noise_color = 'orange'
opt_chnls_freq_psd_noise_linestyle = '--'
opt_chnls_freq_psd_noise_linewidth = 0.8
opt_chnls_freq_psd_noise_marker = 'o'
opt_chnls_freq_psd_noise_markersize = 3
# Freq-domain tab (background and grid settings)
opt_chnls_freq_maj_grid_linestyle = ':'
opt_chnls_freq_maj_grid_linewidth = 0.5
opt_chnls_freq_maj_grid_color = 'gray'
opt_chnls_freq_min_grid_linestyle = ':'
opt_chnls_freq_min_grid_linewidth = 0.5
opt_chnls_freq_min_grid_color = 'lightGray'
...
# Freq-domain tab (data plots)
electrical_freq_fig_back_color = '#f9f9f9'
electrical_freq_plot_back_color = '#f9f9f9'
electrical_freq_labels_axes_color = 'black'
electrical_freq_signal_color = 'b'
electrical_freq_signal_linestyle = '--'
electrical_freq_signal_linewidth = 0.8
electrical_freq_signal_marker = 'o'
electrical_freq_signal_markersize = 3
electrical_freq_noise_color = 'r'
electrical_freq_noise_linestyle = '--'
electrical_freq_noise_linewidth = 0.8
electrical_freq_noise_marker = 'o'
electrical_freq_noise_markersize = 3
electrical_freq_sig_noise_color = 'g'
electrical_freq_sig_noise_linestyle = '--'
electrical_freq_sig_noise_linewidth = 0.8
electrical_freq_sig_noise_marker = 'o'
electrical_freq_sig_noise_markersize = 3
# Freq-domain tab (background and grid settings)
electrical_freq_maj_grid_linestyle = ':'
electrical_freq_maj_grid_linewidth = 0.5
electrical_freq_maj_grid_color = 'gray'
electrical_freq_min_grid_linestyle = ':'
electrical_freq_min_grid_linewidth = 0.5
electrical_freq_min_grid_color = 'lightGray'
# Eye tab (data plots)
electrical_eye_fig_back_color = '#f9f9f9'
electrical_eye_plot_back_color = '#f9f9f9'
electrical_eye_labels_axes_color = 'black'
electrical_eye_signal_color = 'b'
electrical_eye_signal_linestyle = '--'
electrical_eye_signal_linewidth = 0.8
electrical_eye_signal_marker = 'o'
electrical_eye_signal_markersize = 2
electrical_eye_sig_noise_color = 'g'
electrical_eye_sig_noise_linestyle = '--'
electrical_eye_sig_noise_linewidth = 0.8
electrical_eye_sig_noise_marker = 'o'
electrical_eye_sig_noise_markersize = 3
# Time-domain tab (background and grid settings)
electrical_eye_maj_grid_linestyle = ':'
electrical_eye_maj_grid_linewidth = 0.5
electrical_eye_maj_grid_color = 'gray'
electrical_eye_min_grid_linestyle = ':'
electrical_eye_min_grid_linewidth = 0.5
electrical_eye_min_grid_color = 'lightGray'
...
digital_freq_maj_grid_color = 'gray'
digital_freq_min_grid_linestyle = ':'
digital_freq_min_grid_linewidth = 0.5
digital_freq_min_grid_color = 'lightGray'
