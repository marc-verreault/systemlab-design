...
def run(input_signal_data, parameters_input, settings):
    ...
    if add_noise_to_sig == 2: # Move noise to signal array
        signal_array = noise_array
        # Set noise array back to zero
    ...
    '''==RESULTS============================================================'''
    noise_results = []
    noise_pwr_measured = ['Noise power (W)',  total_noise_pwr, 'W', ' ', False]
    noise_pwr_measured_dbm = ['Noise power (dBm)',  total_noise_dbm, 'dBm', ' ', False]
    psd_result = ['PSD (dBm/Hz)', psd, 'dBm/Hz', ' ', False]
