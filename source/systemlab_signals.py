...
class SignalAnalogOpticalCollection():
    ...
    def __init__(self, portID, signal_type, sample_rate, time_array):
        self.portID = portID
        self.signal_type = signal_type
        self.sample_rate = sample_rate
        self.time_array = time_array   
        self.wave_channel_dict = {}

class SignalAnalogOptical():
    
    def __init__(self, wave_key, wave_channel, jones_vector, envelope_array,
                 noise_array, psd_array):
