...
par_title = "<b>Number of wavelength channels</b></td></tr>"
par_text = ('Number of independent wavelength channels that will be created.')
par_dict['Number of wavelength channels'] = (table_start + par_title + text_start
                                        + par_text + text_end)

# Wave key (first index)
par_title = "<b>Wave key (first index)</b></td></tr>"
par_text = ('Wave channel identification code (integer) for the first index. ' +
            'Additional channel keys will be allocated incrementally in steps of 1.')
par_dict['Wave key (first index)'] = (table_start + par_title + text_start
                                        + par_text + text_end)
...
par_title = "<b>Start wavelength/frequency</b></td></tr>"
par_text = "Start wavelength/frequency of first optical channel."
par_dict['Start wavelength/frequency'] = (table_start + par_title + text_start
                                        + par_text + text_end)

# Frequency spacing
par_title = "<b>Frequency spacing</b></td></tr>"
par_text = ('Grid spacing of optical frequencies:<br>' +
            '<i>Freq(n) = Freq_1 + n&times;freq_spacing</i>')
par_dict['Frequency spacing'] = (table_start + par_title + text_start
                                        + par_text + text_end)
...
par_text = "Output power setting of CW lasers. Defined in milliWatts (mW) or dBm."
par_dict['Optical power'] = (table_start + par_title + text_start + 
                             par_text + text_end)

# Laser linewidth
par_title = "<b>Laser linewidth</b></td></tr>"
par_text = ('The laser linewidth specification of all CW lasers (in MHz). ' +
