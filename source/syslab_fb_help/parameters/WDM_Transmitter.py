...
par_title = "<b>Wavelength/frequency</b></td></tr>"
par_text = "Center wavelength/frequency setting of modulated laser."
...
# Optical power (P1)
par_title = "<b>Optical power (P1)</b></td></tr>"
par_text = "Output power setting of laser when fully ON."
par_dict['Optical power (P1)'] = (table_start + par_title + text_start + 
                             par_text + text_end)

# Laser linewidth
par_title = "<b>Laser linewidth</b></td></tr>"
par_text = ('The laser linewidth specification of laser (in MHz). ' +
...
# Extinction ratio
par_title = "<b>Extinction ratio</b></td></tr>"
par_text = ('Defines the minimum power level of the modulated laser when OFF (P0):<br>' +
            '<i>field_fraction_P0 = sqrt(r_ext_linear)<br>' +
            'field_fraction_P1 = 1</i>')
par_dict['Extinction ratio'] = (table_start + par_title + text_start 
                               + par_text + text_end)
